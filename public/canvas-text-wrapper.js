// Fork to include padding on only one side
(function (root) {
  ...
  function CanvasTextWrapper(canvas, text, options) {
    ...
    if (typeof opts.paddingRight !== "undefined") {
      var paddingLeft = (typeof opts.paddingLeft !== "undefined") ? opts.paddingLeft : 0;
      MAX_TXT_WIDTH = EL_WIDTH - opts.paddingRight - paddingLeft;
    }
    var MAX_TXT_HEIGHT = EL_HEIGHT - (opts.paddingY * 2);
    if (typeof opts.paddingBottom !== "undefined") {      
      MAX_TXT_HEIGHT = EL_HEIGHT - opts.paddingBottom;
    }
    ...
    function setHorizAlign() {
      ...
      var paddingX = 0
      if (typeof opts.paddingLeft !== "undefined") {
        paddingX = opts.paddingLeft;
      } else {
    ...
    function setVertAlign() {
      var paddingY = 0
      if (typeof opts.paddingTop !== "undefined") {
        paddingY = opts.paddingTop;
      } else {
      ...
      if (opts.verticalAlign == 'middle') {
        ...
        textPos.y = EL_HEIGHT - textBlockHeight - paddingY;
      } else {
